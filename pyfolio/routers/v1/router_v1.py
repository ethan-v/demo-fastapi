...
from pyfolio.routers.v1 import root_route, files_route, categories_route, posts_route, subscriptions_route, settings_route, courses_route, course_lessons_route
...
router_v1.include_router(settings_route.router, prefix="/courses", tags=["Course"])
router_v1.include_router(courses_route.router, prefix="/courses", tags=["Course"])
router_v1.include_router(course_lessons_route.router, prefix="/course-lessons", tags=["Course Lesson"])
